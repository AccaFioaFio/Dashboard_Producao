...
export const FUNIL_SLICE_META: FunilSliceMeta[] = [
  {
    ...
    group: 'etapa',
    hint: 'Planilha de Corte · pedidos distintos (não é contagem de linha).',
  },
  {
    id: 'comCostura',
    label: 'Com Costura Produção',
    group: 'etapa',
    hint: 'Cortados em 2026 com lançamento Origem = Produção na Costura.',
  },
  {
    id: 'comRevisao',
    label: 'Com Revisão',
  ...
  },
  {
    ...
    group: 'fila',
    hint: 'Cortados sem Costura Produção. Parte pode ter ido para oficina.',
  },
  {
    id: 'semRevisao',
    label: 'Sem Revisão',
    group: 'fila',
    hint: 'Cortados em 2026 ainda sem Data Produção na Revisão.',
  },
  {
    id: 'costuraSemCorte',
    label: 'Costura sem Corte no ano',
    group: 'fila',
    hint: 'Costura Produção 2026 cujo pedido não aparece no Corte 2026.',
  },
  {
    id: 'revisaoSemCorte',
  ...
  {
    id: 'oficinas',
    label: 'Com envio a oficina',
    group: 'fila',
    hint: 'Pedidos com lote enviado a oficina em 2026.',
  },
  {
    id: 'oficinasOrfas',
    label: 'Oficina sem Corte no ano',
    group: 'fila',
    hint: 'Oficina 2026 cujo pedido não aparece no Corte 2026.',
  },
  {
    id: 'wip',
    label: 'Em produção no Corte',
    group: 'parado',
    hint: 'Cada OC (cabeçalho) com status EM PRODUÇÃO. Mesmo pedido pode repetir.',
  },
  {
    id: 'aguardandoTecido',
    label: 'Aguardando tecido',
    group: 'parado',
    hint: 'Cada OC (cabeçalho) com status AGUARDANDO TECIDO. Mesmo pedido pode repetir.',
  },
]
